...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to SplitLedger 🎉');
    } catch (err) {
    ...
    <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm animate-scale-in">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Real-time expense tracking with friends</p>
        </div>
        ...
        <div className="card p-6 border-surface-700">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)}
                  placeholder="Arjun Sharma" className="input pl-9" />
              </div>
            </div>
            <div>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center"><span className="px-3 text-xs text-slate-500 bg-surface-800">or</span></div>
          </div>
